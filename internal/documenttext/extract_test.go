...
func TestExtractDocxText(t *testing.T) {
	...
	files := map[string]string{
		...
		"word/document.xml":   `<?xml version="1.0"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>Humbert document test</w:t></w:r></w:p></w:body></w:document>`,
	}
