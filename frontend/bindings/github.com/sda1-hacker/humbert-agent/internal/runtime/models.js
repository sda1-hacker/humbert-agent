...
export class Event {
    ...
    static createFrom($$source = {}) {
        ...
        if ("skillNames" in $$parsedSource) {
            $$parsedSource["skillNames"] = $$createField14_0($$parsedSource["skillNames"]);
        }
        if ("mcpServers" in $$parsedSource) {
            $$parsedSource["mcpServers"] = $$createField16_0($$parsedSource["mcpServers"]);
        }
